...
import { getCompanyBranding, ensureManagementSummaryRef } from '@/lib/branding';
...
export async function GET(_req, { params }) {
  ...
  // Assigned atomically — a snapshot gets exactly one reference number, ever, no matter how
  // many times (or how close together) the report is regenerated.
  const referenceNumber = await ensureManagementSummaryRef(company.id, params.id);
